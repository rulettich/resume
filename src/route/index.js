  ...
  res.render('education', {
    ...
    main: {
      educations: [
        ...
        {
          name: 'Lviv National University of Veterinary Medicine and Biotechnology named after Stepan Gzhitskyi',
          isEnd: true,
        },
      ],
      ...
      certificates: [
        ...
        {
          name: 'Тренер з продажу',
          id: 456,
        },
        {
          name: 'Спеціаліст по роботі з клієнтами',
          id: 789,
        },
      ],
    },
          ...
          responsibilities: [
            {
              ...
              text: 'Worked on improving search algorithms',
            },
          ],
          year_founded: 1990,
          industry: 'Technology',
    ...
    quiz: {
      ...
      factors: {
        ...
        options: [
          {
            One: 'Ціна',
            Two: 'Репутація бренду',
            Three: 'Якість',
            Four: 'Особливості',
            Five: 'Гарантія',
            Six: 'Доступність',
            Seven: 'Обслуговування клієнтів',
          },
        ],
      },
    },
